...
- Course Content
	- Reference Sheets [Unity-Scripting-01](reference-sheets/Unity-Scripting-01.md), [Unity-Scripting-02](reference-sheets/Unity-Scripting-02.md), and [Unity-Scripting-03](reference-sheets/Unity-Scripting-03.md)
	- Presentations [Unity C#](https://docs.google.com/presentation/d/1MGj13NImP0btn-mEF2TZEXISG4P8WyBWGkE1m1rpQPk/edit#slide=id.g432bd6f119_0_0) - Introduction, variables, types, etc.
...
- Course Content
	- Reference Sheets [Unity-Graphics-Sprites-Textures](reference-sheets/Unity-Graphics-Sprites-Textures.md) and [Unity-Animation](reference-sheets/Unity-Animation.md)
	- Presentations [Unity Animation Overview](https://docs.google.com/presentation/d/1-n_liOU9KDtEd-g_1QxkkJVF2y4G1soQUqby3Ds-DTU/edit#slide=id.g432bd6f119_0_0) and [Unity 2D Sprite Animation](https://docs.google.com/presentation/d/1E5lQSRzyHpAUNQvSKvvi7bZn_I9DXcA5I5ly2Si-7B0/edit#slide=id.g432bd6f119_0_0)
- "Penny Pixel" Unity Tutorial [2D Platformer Character Controller](https://learn.unity.com/tutorial/live-session-2d-platformer-character-controller) series and source files
	- [Introduction and Session Goals [1/8]](https://www.youtube.com/watch?v=wGI2e3Dzk_w&list=PLX2vGYjWbI0SUWwVPCERK88Qw8hpjEGd8&ab_channel=Unity) (4:56)
	- [Scripting Gravity [2/8]](https://www.youtube.com/watch?v=hn9lkAua3Vk&list=PLX2vGYjWbI0SUWwVPCERK88Qw8hpjEGd8&index=2&ab_channel=Unity) (7:39)
	- [Detecting Overlaps [3/8]](https://www.youtube.com/watch?v=nyVfYhaomVQ&list=PLX2vGYjWbI0SUWwVPCERK88Qw8hpjEGd8&index=3&ab_channel=Unity) (9:00) ...
- Brackeys Playlist [How to make a 2D Game](https://www.youtube.com/playlist?list=PLPV2KyIb3jR6TFcFuzI2bB7TMNIIBpKMQ) [Github](https://github.com/Brackeys/2D-Character-Controller)
	- [How to make a 2D Game in Unity](https://www.youtube.com/watch?v=on9nwbZngyw&list=PLPV2KyIb3jR6TFcFuzI2bB7TMNIIBpKMQ&ab_channel=Brackeys) (14:28)
	- [2D Movement in Unity (Tutorial)](https://www.youtube.com/watch?v=dwcT-Dch0bA&list=PLPV2KyIb3jR6TFcFuzI2bB7TMNIIBpKMQ&index=2&ab_channel=Brackeys) (21:08)
	- [2D Animation in Unity (Tutorial)](https://www.youtube.com/watch?v=hkaysu1Z-N8&list=PLPV2KyIb3jR6TFcFuzI2bB7TMNIIBpKMQ&index=3&t=987s&ab_channel=Brackeys) (21:52) ...
- Lynda [Advanced Unity 2D: Platformer Player Movement](https://www.lynda.com/Unity-tutorials/Advanced-Unity-2D-Platformer-Player-Movement/367449-2.html)
- BoardToBits [Better Jumping in Unity With Four Lines of Code](https://www.youtube.com/watch?v=7KiK0Aqtmzc&ab_channel=BoardToBitsGames) (12:46)
- GDC [Math for Game Programmers: Building a Better Jump](https://www.youtube.com/watch?v=hG9SzQxaCm8&ab_channel=GDC) (25:42)


### 3D Games

- Course Content
	- Reference Sheets [Unity Coordinate Systems](https://docs.google.com/presentation/d/1jM4qaNMo2Qvinjw5ps5Doz69OMFUkMlIGcn0XszCRo0/edit#slide=id.p), [Unity-Graphics-3D](reference-sheets/Unity-Graphics-3D.md), and [Unity-Graphics-Lighting](reference-sheets/Unity-Graphics-Lighting.md)
	- Presentations [Unity 3D Graphics](https://docs.google.com/presentation/d/1jM4qaNMo2Qvinjw5ps5Doz69OMFUkMlIGcn0XszCRo0/edit#slide=id.gbe4e77c190_0_0)
...
- GDC [Ten Principles for Good Level Design](https://www.youtube.com/watch?v=iNEe3KhMvXM&ab_channel=GDC) (1:00:47)
...
- GDC [Storytelling Tools to Boost Your Indie Game's Narrative and Gameplay](https://www.youtube.com/watch?v=8fXE-E1hjKk&ab_channel=GDC) (29:26)
...
- Course Content
	- Presentations [Dialogue with Yarn Spinner](https://docs.google.com/presentation/d/1jM4qaNMo2Qvinjw5ps5Doz69OMFUkMlIGcn0XszCRo0/edit#slide=id.g49e5aefa3e_0_23)
...
- Course Content
	- Reference Sheets [Unity-Graphics-Sprites-Textures](reference-sheets/Unity-Graphics-Sprites-Textures.md) and [Unity-Animation](reference-sheets/Unity-Animation.md)
	- Presentations [How to make pixel art for Unity games with Photoshop](https://www.youtube.com/watch?v=EHtpluQHq8Q&ab_channel=OwenMundy) (23:03)
...
- Brackeys
	- [Tilemaps in Unity](https://www.youtube.com/watch?v=ryISV_nH8qw) (13:44)
...
- Course Content
	- Reference Sheet [Unity-Git](reference-sheets/Unity-Git.md)
	- Presentations [Git & Github Desktop slides](https://docs.google.com/presentation/d/1vtK6LoqwF4rQQZZy-ovuEgsYUwwMRXsqDVMOjAPSBt0/edit) and [Unity Collaboration and Version Control](https://docs.google.com/presentation/d/1phoKp9d7BjhM0scs78rim6DtcUGoJAy4L31eDrR3zGE/edit#slide=id.g432bd6f119_0_0)
...
- GDC [Building a Paper Prototype For Your Narrative Design](https://www.youtube.com/watch?v=taxcb_5lEI8&ab_channel=GDC) (30:22)
- Tools
	- Pencil and paper!
...
- Course Content
	- Reference Sheets [Unity-Performance](reference-sheets/Unity-Performance.md) and [Unity-Scripting-Debugging](reference-sheets/Unity-Scripting-Debugging.md)
...
- DaGraca and Lukosek. [Learning C# By Developing Games with Unity 2017 (3rd Ed.)](https://www.packtpub.com/game-development/learning-c-7-developing-games-unity-2017-third-edition) Packt, 2017. [Github](https://github.com/PacktPublishing/Learning-C-7-By-Developing-Games-with-Unity-2017-Third-Edition)
...
- Felicia, Patrick. [A Beginner's Guide to 2D Platform Games with Unity](https://www.amazon.com/Beginners-Guide-Platform-Games-Unity/dp/1520118171) (2016)
