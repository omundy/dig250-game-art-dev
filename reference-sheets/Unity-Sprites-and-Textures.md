...
[Sprite Sorting Layers](https://docs.unity3d.com/Manual/class-TagManager.html) | Sorting Layers are used in conjunction with Sprite graphics in the 2D system. Sorting refers to the overlay order of different Sprites.
[Layers](https://docs.unity3d.com/Manual/Layers.html) | Layers are most commonly used by Cameras to render only a part of the scene, and by Lights to illuminate only parts of the scene. But they can also be used by raycasting to selectively ignore colliders or to create collisions. They are different than Sprite Sorting Layers.
