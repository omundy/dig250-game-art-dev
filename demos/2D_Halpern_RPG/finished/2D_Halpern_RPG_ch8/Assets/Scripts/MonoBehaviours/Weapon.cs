...
public class Weapon : MonoBehaviour
{
    ...
    {
        // get reference to current transform
        Vector2 playerPosition = gameObject.transform.position;
        // convert inputPosition to world space
    ...
    // determine which quadrant user has clicked
...
void UpdateState()
    ...
    // loop through pool and find first inative object
